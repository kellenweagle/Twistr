      ...
      <div className="blog-list">
        <div className='blog-link'>
          <span className='blog-photo-and-text'>
            <img className="blog-photo" src="../../../images/blog-1.png" alt=""/>
        ...
        <div className='blog-link'>
          <span className='blog-photo-and-text'>
            <img className="blog-photo" src="../../../images/blog-2.jpg" alt=""/>
            <div className='blog-name-text'>
        ...
        <div className='blog-link'>
          <span className='blog-photo-and-text'>
            <img className="blog-photo" src="../../../images/blog-3.jpg" alt=""/>
            <div className='blog-name-text'>
        ...
        <div className='blog-link'>
          <span className='blog-photo-and-text'>  
            <img className="blog-photo" src="../../../images/blog-4.jpg" alt=""/>
            <div className='blog-name-text'>
